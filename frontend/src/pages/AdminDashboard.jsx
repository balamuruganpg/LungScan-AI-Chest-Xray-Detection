          ...
          <div className="flex items-center gap-3">
            <div className="p-4 rounded-2xl bg-slate-950/80 border border-cyber-border text-right min-w-[240px]">
              ...
              <span className="text-xs font-mono text-slate-400 block">
                {profile?.email || 'balamuruganpg@outlook.com'}
              </span>
            </div>
        ...
        <div className="w-full overflow-x-auto no-scrollbar flex items-center gap-1.5 p-1.5 rounded-2xl bg-slate-950/80 border border-cyber-border backdrop-blur-xl relative flex-nowrap sm:flex-wrap">
          <button
            ...
            className={`relative shrink-0 whitespace-nowrap px-3 sm:px-4 py-2 rounded-xl text-xs font-extrabold transition-colors flex items-center gap-2 z-10 ${
              activeTab === 'doctors' ? 'text-white' : 'text-slate-400 hover:text-slate-200'
            }`}
          >
          ...
          <button
            ...
            className={`relative shrink-0 whitespace-nowrap px-3 sm:px-4 py-2 rounded-xl text-xs font-extrabold transition-colors flex items-center gap-2 z-10 ${
              activeTab === 'patients' ? 'text-white' : 'text-slate-400 hover:text-slate-200'
            }`}
          >
          ...
          <button
            ...
            className={`relative shrink-0 whitespace-nowrap px-3 sm:px-4 py-2 rounded-xl text-xs font-extrabold transition-colors flex items-center gap-2 z-10 ${
              activeTab === 'scans' ? 'text-white' : 'text-slate-400 hover:text-slate-200'
            }`}
          >
                    ...
                    <tr key={doc.id} className="table-row-hover transition-colors">
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <button
                          ...
                          className={`px-3 py-1 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 ml-auto ${
                            isActive
          ...
          <div className="p-6 rounded-3xl bg-cyber-card border border-cyber-border shadow-xl space-y-4">
            ...
            <div className="p-4 rounded-2xl bg-slate-950 border border-cyber-border space-y-2 text-xs font-mono">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-purple-300 font-bold">balamuruganpg@outlook.com</span>
              </div>
            </div>
          </div>
        </div>
